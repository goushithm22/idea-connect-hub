  ...
  return (
    <div className="relative w-full h-full max-w-[500px] max-h-[500px]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] animate-rotate-circle">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-5 h-5 rounded-full bg-idea"></div>
      </div>
      
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] animate-rotate-circle" style={{ animationDuration: '20s' }}>
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-lightgrey-300"></div>
      </div>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px]">
        {Array.from({ length: 6 }).map((_, i) => (
          <div 
            key={i}
            className="absolute w-2 h-2 rounded-full bg-lightgrey-300"
            style={{
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100px] h-[100px] flex items-center justify-center">
        ...
        <div className="absolute w-10 h-10 rounded-full bg-idea"></div>

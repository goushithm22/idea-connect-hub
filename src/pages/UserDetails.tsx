    ...
    <div className="space-y-6">
      ...
      <Card className="bg-white border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
        <CardHeader className="border-b border-gray-100 pb-4">
          <CardTitle className="text-xl font-semibold text-blue-600">User Details</CardTitle>
        </CardHeader>
      ...
      <Card className="bg-white border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
        <CardHeader className="border-b border-gray-100 pb-4">
          <CardTitle className="text-xl font-semibold text-blue-600">Listed Companies</CardTitle>
        </CardHeader>
        <CardContent className="pt-5">
          {user.companies.length > 0 ? (
            <ul className="space-y-4">
              {user.companies.map((company, index) => (
                <li key={index} className="p-4 border border-gray-200 rounded-md hover:border-blue-500 hover:shadow-sm transition-all duration-300">
